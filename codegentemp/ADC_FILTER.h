...
*******************************************************************************/
    ...
    #define ADC_CFG0_FILTER_GT_C1_NUMERATOR_VAL    (17ul)
    #define ADC_CFG0_FILTER_GT_C1_DENOMINATOR_VAL  (1ul)
    #define ADC_CFG0_FILTER_GT_C2_NUMERATOR_VAL    (18ul)
    #define ADC_CFG0_FILTER_GT_C2_DENOMINATOR_VAL  (1ul) 
    #define ADC_CFG0_FILTER_GT_C3_VAL              (39ul)      
    #define ADC_CFG0_FILTER_GT_C4_VAL              (37ul)      
    #define ADC_CFG0_FILTER_GT_Cp_VAL              (0ul)      
    #define ADC_CFG0_FILTER_GT_Cpp_NUMERATOR_VAL   (4ul)  
    #define ADC_CFG0_FILTER_GT_Cpp_DENOMINATOR_VAL (1ul)  
    #define ADC_CFG0_FILTER_GT_CA_VAL              (64ul)      
    #define ADC_CFG0_FILTER_GT_CB_VAL              (40ul)     
